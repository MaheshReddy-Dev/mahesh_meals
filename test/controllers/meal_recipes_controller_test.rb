...
class MealRecipesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meal_recipe" do
    assert_difference("MealRecipe.count") do
      post meal_recipes_url, params: { meal_recipe: { meal_id: @meal_recipe.meal_id, name: @meal_recipe.name } }
    end
  ...
  test "should update meal_recipe" do
    patch meal_recipe_url(@meal_recipe), params: { meal_recipe: { meal_id: @meal_recipe.meal_id, name: @meal_recipe.name } }
